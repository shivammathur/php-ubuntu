...
DEBIAN_FRONTEND=noninteractive apt-get install -y snmp snmp-mibs-downloader firebird-dev freetds-dev libargon2-dev libaspell-dev libc-client2007e libcurl4-openssl-dev libdb-dev libexpat1-dev libhunspell-dev libjson-c-dev libkmod-dev libnorm-dev libpgm-dev libpq-dev libqdbm-dev librabbitmq-dev libsnmp-dev libssl-dev libtidy-dev libtiff-dev libtommath-dev libwebp-dev libxpm-dev libxslt1-dev libyaml-dev libzip-dev udev tzdata
