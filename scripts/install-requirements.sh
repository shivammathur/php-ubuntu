...
if [[ "${LIBS:?}" = "false" ]]; then
  ...
  DEBIAN_FRONTEND=noninteractive apt-get install -y snmp firebird-dev freetds-dev libargon2-dev libaspell-dev libc-client2007e libdb-dev libhunspell-dev libjson-c-dev libkmod-dev libmemcached-dev libnorm-dev libpgm-dev libpq-dev libqdbm-dev librabbitmq-dev libssl-dev libtidy-dev libtommath-dev libtiff5-dev libwebp-dev libxpm-dev libxslt1-dev libyaml-dev libzip-dev tzdata
