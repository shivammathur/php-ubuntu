...
DEBIAN_FRONTEND=noninteractive apt-get install -y firebird-dev freetds-dev libargon2-dev libaspell-dev libc-client2007e libdb-dev libgd-dev libhunspell-dev libjson-c-dev libkmod-dev libmemcached-dev libnorm-dev libpgm-dev libpq-dev libqdbm-dev librabbitmq-dev libssl-dev libtidy-dev libtommath-dev libwebp-dev libxpm-dev libxslt1-dev libyaml-dev libzip-dev tzdata
