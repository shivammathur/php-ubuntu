...
DEBIAN_FRONTEND=noninteractive apt-get install -y apache2 apt-fast automake file gcc g++ git jq make pkg-config shtool libtool sudo systemd unzip
...
purge_packages libgd-dev uuid-dev libfreetype-dev libfreetype6 libfribidi-dev libharfbuzz-dev liblzma-dev libtiff-dev libgd3 libavif13 libavif16 libimagequant0 libraqm0 libyuv0 libaom3 libdav1d5 libgav1-0 libabsl20210324 libdav1d7 libgav1-1 librav1e0 libsvtav1enc1d1 libabsl20220623t64 || true
arch="$(arch)"
